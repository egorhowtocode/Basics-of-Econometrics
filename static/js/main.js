...
const stageInfo = {
  discovery: {
    title: 'Зарождение (Discovery)',
    description: "ИИ появляется как исследовательская идея: первые публикации, прототипы и лабораторные эксперименты без практических внедрений."
  },
  trigger: {
    title: 'Триггер (Trigger)',
    description: "Технологии ИИ начинают тестироваться в пилотных проектах. Появляются стартапы, первые инвестиции и внимание СМИ."
  },
  peak: {
    title: "Пик ожиданий (Hype Peak)",
    description: "Общество и бизнес ждут революционных изменений от ИИ. Много обещаний, быстрых инвестиций и «модных» внедрений, часто без реальной отдачи."
  },
  trough: {
    title: "Разочарование (Shakeout)",
    description: "Часть проектов закрывается, бизнес видит слабые места технологий, снижается доверие и инвестиции. Происходит отбор реально жизнеспособных решений."
  },
  slope: {
    title: "Просветление (Slope of Enlightenment)",
    description: "ИИ начинает приносить ощутимую пользу. Компании учатся правильно внедрять технологии, появляются устойчивые бизнес-кейсы и первые масштабные пилоты."
  },
  plateau: {
    title: "Плато продуктивности (Productivity Plateau)",
    description: "ИИ становится массовым инструментом. Технологии стандартизированы, интегрированы в бизнес-процессы и продукты. Рост идет через эффективность, а не хайп."
  },
  legacy: {
    title: "Наследие (Legacy)",
    description: "ИИ превращается в «фоновую» технологию. Она работает как инфраструктура, но теряет новизну. На смену приходят новые волны исследований и инноваций."
  }
};
...
function highlightSegment(seg) {
  ...
  descPanel.innerHTML = `
    <div class="text-green-500 font-bold mb-1">${title}</div>
